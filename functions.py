...
def cyclemotto():
  ...
  s.append("Pipulate is designed to be customized to do almost anything.")
  s.append("Pipulate turns your spreadsheet into a \"for each\" loop.")
  s.append("Each column in sheet represents either a function's input or output.")
  s.append("99% of the time, the URL column is one of the functions' input.")
  s.append("Many Pipulate functions take URL as input, like \"Liked\".")
  s.append("Look-up Liked, Shared, Plused, & Tweeted against URLs to grok it.")
  ...
  s.append("Pipulate: It Slices. It Dices. It teaches you to cook.")
  s.append("Quota scmhmota! I pipulate in your general direction.")
